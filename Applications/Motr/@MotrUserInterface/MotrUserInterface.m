...
%            'HandleVisibility','callback',...
            ...
            'Units','pixels',...
            'Title','Operations',...
            'Position',[figureLeftPad          180          operationsPanelWidth          183],...
            'Clipping','off',...
            'Tag','hOperations');
...
%            'BackgroundColor',[0 1 1],...
            ...
            'Title','Processing',...
            'Position',[ 21.6944801026957          56+32.5552050473186          100.962772785623          84.6435331230284],...
         ...
         %
            ...
            self.parModeButtonGroup_ = uibuttongroup(...
            'Parent',self.figureGH_,...
            'Units','pixels',...
            'SelectionChangeFcn',@(hObject,eventdata)(self.hParModeGroup_SelectionChangeFcn(eventdata)),...
            'Title','ParFor',...
            'Position',[ 21.6944801026957          6.5552050473186          100.962772785623          74.6435331230284],...
            'Tag','hParModeGroup');

            self.singleModeRadiobutton_ = uicontrol(...
            'Parent',self.parModeButtonGroup_,...
            'Units','pixels',...
            'String','No',...
            'Value',1,...
            'Style','radiobutton',...
            ...
            self.parModeRadiobutton_ = uicontrol(...
            'Parent',self.parModeButtonGroup_,...
            'Units','pixels',...
            'String','Yes',...
            'Style','radiobutton',...
            'Position',[   20           29          60          24],...
            'Tag','hParMode');
...
%             end
        ...
        function hParModeGroup_SelectionChangeFcn(self, eventdata)
            tag=get(eventdata.NewValue,'Tag');
            if strcmp(tag,'hSingleMode')
                parMode=0;
