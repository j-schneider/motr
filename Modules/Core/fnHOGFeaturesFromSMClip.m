function  [a2fHOGFeatures,a2fHOGFeaturesFlipped,a3iPatches, ...
    ...
    fnHOGFeaturesFromSMClip(strctInputFile,a2bMask,a2fBackground,parMode)
...
temp_g.m_strctClassifiers.m_fImagePatchHeight=g_strctGlobalParam.m_strctClassifiers.m_fImagePatchHeight;
temp_g.m_strctClassifiers.m_fImagePatchWidth=g_strctGlobalParam.m_strctClassifiers.m_fImagePatchWidth;
...
if parMode
    ppm = ParforProgMon('Progress on file - ', iNumFrames);
    fprintf('Passing frames\n');
    parfor iFrameIter=1:iNumFrames
        ...
        a2iPatch = ...
            ...
            strctEllipse.m_afX, ...
            strctEllipse.m_afY, ...
            strctEllipse.m_afTheta, temp_g);  % uint8
